    ...
    stages {
        ...
        stage('push image') {
            ...
            steps {
                ...
                sh 'mvn clean compile jib:build --no-transfer-progress -DskipTests -Dpush.image.base=localhost:8081/dev -DsendCredentialsOverHttp=true -Dpush.image.tag=' + DEPLOY_ENV + ' -P jib'
